...
def main():
    ...
    parser.add_argument("-y", "--yaml_dir", default="/home/mmagnan4/Desktop/dvrk_camera_stereo_calibration", help="Directory containing left.yaml and right.yaml")
    ...
    pipeline1, appsink1 = make_capture_pipeline(1)
    pipeline1.set_state(Gst.State.PLAYING)
    pipeline2, appsink2 = make_capture_pipeline(0)
    ...
    if args.publish:
        gst_out = (
            ...
            f"video/x-raw,framerate=24/1 ! x264enc name=videoEnc bitrate=1380 tune=zerolatency pass=qual ! "
    ...
    try:
        ...
        while True:
            ...
            rect_left = cv2.convertScaleAbs(rect_left, alpha=contrast, beta=brightness)
            rect_right = cv2.convertScaleAbs(rect_right, alpha=contrast, beta=brightness)
            # Concatenation
